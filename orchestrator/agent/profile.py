...
- Use `get_context_remaining` only when context-window pressure matters.
- Use `new_context_window` when the current thread is too large and you need a fresh compacted window before continuing.
